...
//		    
	...
	//User - Live Guru
	public void clickSubMenuByLabelName(WebDriver driver,String menuLabel, String subMenuLabel) {
		waitForElementClickable(driver, UserBasePageUI.DYNAMIC_MENU_BY_LABEL_NAME, menuLabel);
		clickToElement(driver, UserBasePageUI.DYNAMIC_MENU_BY_LABEL_NAME, menuLabel);
		waitForElementClickable(driver, UserBasePageUI.DYNAMIC_SUB_MENU_BY_LABEL_NAME, subMenuLabel);
		clickToElement(driver, UserBasePageUI.DYNAMIC_SUB_MENU_BY_LABEL_NAME, subMenuLabel);
	}
	
	public void enterToTextboxByID(WebDriver driver, String idTextbox, String value) {
		waitForElementVisible(driver, UserBasePageUI.DYNAMIC_TEXT_BOX_BY_ID,idTextbox);
		sendKeyToElement(driver, UserBasePageUI.DYNAMIC_TEXT_BOX_BY_ID,value,idTextbox);
	}
	
	public void clickButtonByAttributeTitle(WebDriver driver, String titleAttribute) {
		waitForElementClickable(driver, UserBasePageUI.DYNAMIC_BUTTON_BY_ATTRIBUE_TITLE, titleAttribute);
		clickToElement(driver, UserBasePageUI.DYNAMIC_BUTTON_BY_ATTRIBUE_TITLE, titleAttribute);
	}

	public void clickMenuInNavigationByLabel(WebDriver driver, String menuLabel) {
		waitForElementClickable(driver, UserBasePageUI.DYNAMIC_MENU_IN_NAVIGATION_BY_LABEL, menuLabel);
		clickToElement(driver, UserBasePageUI.DYNAMIC_MENU_IN_NAVIGATION_BY_LABEL, menuLabel);
	}
	
	public void enterToTextAreaByID(WebDriver driver, String idTextArea, String value) {
	...
	public void clickLinkByLabel(WebDriver driver, String labelLink) {
		waitForElementClickable(driver, UserBasePageUI.DYNAMIC_LINK_BY_LABEL, labelLink);
		clickToElement(driver, UserBasePageUI.DYNAMIC_LINK_BY_LABEL, labelLink);
	}
	
	public void clickRadioButtonByID(WebDriver driver, String idRadioButton) {
		waitForElementClickable(driver, UserBasePageUI.DYNAMIC_RADIO_BUTTON_BY_ID, idRadioButton);
		clickToElement(driver, UserBasePageUI.DYNAMIC_RADIO_BUTTON_BY_ID, idRadioButton);
	}
	...
	public void clickFooterLinkByLabel(WebDriver driver, String footerLinkLabel) {
		waitForElementClickable(driver, UserBasePageUI.DYNAMIC_FOOTER_LINK_BY_LABEL,footerLinkLabel);
		clickToElement(driver, UserBasePageUI.DYNAMIC_FOOTER_LINK_BY_LABEL,footerLinkLabel);
	}

	public void clickButtonJSByAttributeTitle(WebDriver driver, String titleAttribute) {
		waitForElementClickable(driver, UserBasePageUI.DYNAMIC_BUTTON_BY_ATTRIBUE_TITLE, titleAttribute);
		clickToElementByJS(driver, UserBasePageUI.DYNAMIC_BUTTON_BY_ATTRIBUE_TITLE, titleAttribute);
	}
}
